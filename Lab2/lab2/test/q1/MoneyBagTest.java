...
//    }
    ...
    @Test
    public void testZeroMoneyBag() {
        // Create a zero MoneyBag
        MoneyBag zeroMoneyBag = new MoneyBag();

        // Create a zero IMoney instance
        IMoney zeroIMoney = new Money(0, "USD");

        // Assert that zero MoneyBag equals zero IMoney instance as both are zero
        assertTrue("A zero MoneyBag should be equal to another IMoney instance that is also zero", zeroMoneyBag.equals(zeroIMoney));
    }
    
    @Test
    public void testMoneyBagNotEqualDifferentSizes() {
        // Create two MoneyBags
        MoneyBag bag1 = new MoneyBag();
        MoneyBag bag2 = new MoneyBag();

        // Add Money to each bag 
        bag1.appendMoney(new Money(10, "USD"));
        bag2.appendMoney(new Money(10, "USD"));
        bag2.appendMoney(new Money(5, "CHF")); // Bag2 has more Money objects

        // Assert that these two are not equal due to different sizes
        assertFalse("Two MoneyBags with different sizes should not be equal", bag1.equals(bag2));
    }

    
    @Test
    public void testMoneyBagNotEqualsDifferentObject() {
        MoneyBag moneyBag = new MoneyBag(); 
        Object differentObject = new Object(); // Get instance of object class
        assertFalse("MoneyBag should not be equal to an object of a different class", moneyBag.equals(differentObject));
    }
